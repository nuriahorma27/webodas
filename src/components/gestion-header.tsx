...
const sectionInfo: Record<string, { eyebrow: string; title: string; description: string }> = {
  ...
  invitados: { eyebrow: "Invitados", title: "Lista de invitados", description: "Gestionad asistentes, acompañantes, confirmaciones y datos prácticos de cada persona." },
...
export function GestionHeader() {
  ...
  return (
    <header className="gestion-heading">
      <h1 className="font-display text-3xl leading-none sm:text-4xl">{info.title}</h1>
