...
const DATA: Record<string, Def[]> = {
  ...
  Decoración: [
    ...
    ["Seating plan y nombres de mesas", "Último mes", "lista", "Se organiza en webodas · Mesas"],
  ...
  "Otros de la boda": [
    ...
    ["Recoger confirmaciones (RSVP)", "2-3 meses antes", "simple", "Se hace en webodas · Confirmaciones"],
    ...
    ["Baile nupcial", "2-3 meses antes", "eleccion"],
