  ...
  content: [
    ...
    },
    {
      ...
      props: {
        ...
        colorBg: "",
        items: [
          { time: "12:00", label: "Ceremonia", note: "En la iglesia del pueblo" },
          { time: "13:30", label: "Cóctel", note: "En los jardines de la finca" },
          { time: "15:30", label: "Banquete", note: "" },
          { time: "19:00", label: "Fiesta", note: "Barra libre hasta el final" },
        ],
      },
    },
